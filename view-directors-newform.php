...
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#newDirectorModal">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form method="post" action="">
            ...
            <div class="mb-3">
              <label for="dAge" class="form-label">Director Age</label>
              <input type="text" class="form-control" id="dAge" name="dAge">
            </div>
          <div class="mb-3">
              <label for="dMovies" class="form-label">Movies Made</label>
              <input type="text" class="form-control" id="dMovies" name="dMovies">
            </div>
